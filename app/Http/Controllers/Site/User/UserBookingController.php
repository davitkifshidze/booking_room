...
use App\Http\Requests\RequestUserBooking;
...
class UserBookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Booking::select('bookings.id', 'rooms.name as room_name', 'users.name as user_name', 'users.surname', 'bookings.start_date', 'bookings.end_date', 'bookings.created_at', 'bookings.updated_at')
        ...
        return view('site.user.booking.index', compact('bookings','rooms', 'user', 'room_id', 'date'));
     ...
     */
    public function store(RequestUserBooking $request)
    {
