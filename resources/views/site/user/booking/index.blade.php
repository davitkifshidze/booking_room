...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('css/site/user/booking/index.css') }}">
    <link rel="stylesheet" href="{{ asset('css/site/user/booking/modal.css') }}">
...
@section('script')
    ...
    <script src="{{ asset('js/site/user/booking/index.js') }}"></script>
    <script src="{{ asset('js/site/user/booking/modal.js') }}"></script>
...
@section('content')
    ...
    <div class="booking">
        ...
        <div class="booking__table__container">
            <div class="booking__header">
                ...
                <form action="{{ route('user_booking') }}" method="GET"  class="search__form" >
                ...
                <table class="booking__table">
                    ...
                    @foreach($bookings as $key => $booking)
                        <tr>
                            ...
                            <td class="tbody__td">{{ $booking->user_name . " " . $booking->surname }}</td>
    ...
    @include('site.user.booking.modal')
